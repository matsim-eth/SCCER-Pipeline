...
## ----------------------------------------------------------------------	#########
##												##
KantMATS = "JU"			## MATSim-Kantonsname eingeben, z.B. "ZH"			##
KantVZ   = 26			## VZ2000 Kantonsnummer eingeben, z.B. 1			##
Fuelprice = 1.75			## Benzinpreis in CHF/Liter, Default ist 1.75		##
##												##
######################################################################################
...
Zatog$Text1[1] <- "input"
Zatog$Text2[1] <- paste("/Network/Servers/kosrae.ethz.ch/Volumes/ivt-home/bjaeggi/MATSim_Implementation/Sim_Input_Data/G_HHs_",KantMATS,"_",Fuelprice,".dat;",sep="")
Zatog$Text1[2] <- "output"
Zatog$Text2[2] <- paste("/Network/Servers/kosrae.ethz.ch/Volumes/ivt-home/bjaeggi/MATSim_Implementation/Sim_Input_Data/G_HHs_",KantMATS,"_",Fuelprice,"1.dat;",sep="")
Zatog$Text1[3] <- "invar"
...
setwd("/Network/Servers/kosrae.ethz.ch/Volumes/ivt-home/bjaeggi/MATSim_Implementation")
