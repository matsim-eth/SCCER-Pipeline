...
insert into participants values ( '1647', 'Smith', 'John', 'joseph.molloy@ivt.baug.ethz.ch', true, 1);
insert into participants values( '1681', 'Doe', 'Jane', 'joseph.molloy@ivt.baug.ethz.ch', false, 1);
insert into participants values( '1595', 'Sparrow', 'Jack', 'joseph.molloy@ivt.baug.ethz.ch', true, 1);

insert into participants values( '1596', 'Stark', 'Captain', 'joseph.molloy@ivt.baug.ethz.ch', false, 1);
insert into participants values( '1607', 'Jones', 'Bob', 'joseph.molloy@ivt.baug.ethz.ch', false, 1);
