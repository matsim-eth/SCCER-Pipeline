...
create table participants (person_id text primary key, last_name text, first_name text, email_address text, male bool);

insert into participants values ( '1723', 'Smith', 'John', 'joseph.molloy@ivt.baug.ethz.ch', true);
insert into participants values( '1650', 'Doe', 'Jane', 'joseph.molloy@ivt.baug.ethz.ch', false);
