...
Indeed, it can be seen that larger cities such as Zurich and Bern and highly populated canton such as Zurich, Bern and Vaud produce higher total emissions than rural areas within e.g. Graubünden, Schwyz or Appenzell.
...
The MATSim computed delay values are then compared to those calculated by \cite{}.
...
The values are reported in \Cref{ab:delayValueComparison}.
...
{%
  \begin{tabular}[c]{lrrr}
    \toprule
    Road type & Infras/MK (Mio Veh h / a) & MATSim (Mio Veh h / a) & \%  \\ 
    \midrule
