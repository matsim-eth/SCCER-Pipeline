...
Specifically, external costs for 12 different cost categories are computed, differentiated by transport mode, \red{type} and user. 
...
\citet{foen2010pollutants} use the HBEFA to provide an detailed analysis of past and predicted future pollutant emissions, covering road transport in Switzerland from 1990 to 2035.\red{a bit more here on this source?}
...
A summary of thier results is provided in Table \Cref{tab:vehHoursDelayMkInfras}.
The values provide a useful estimate of delay costs in Switzerland, however, the use of an "at-least" approach will tend to underestimate the lost time and resulting associated delay costs. \red{cite}
