 ...
 */
public class MATSimOsmHbefaMapping implements HbefaRoadTypeMapping {
    ...
    public static MATSimOsmHbefaMapping build() {
        //This mapping is not literal from the Network
        MATSimOsmHbefaMapping mapping = new MATSimOsmHbefaMapping();
        mapping.hbfeaMap.put("motorway-Nat.", new Hbefa("MW-Nat.",80,120));
        ...
        mapping.hbfeaMap.put("living_street", new Hbefa("Access",30,50));
    ...
    private String getHEBFAtype(String roadType, double freeVelocity) {
        ...
        //calculate the speed category of the link, using defined minimums and maximums
