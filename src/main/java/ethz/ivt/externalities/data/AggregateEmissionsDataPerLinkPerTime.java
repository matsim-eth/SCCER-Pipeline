...
public class AggregateEmissionsDataPerLinkPerTime implements AggregateDataPerTime<Link>{
    protected static final Logger log = Logger.getLogger(AggregateEmissionsDataPerLinkPerTime.class);
    ...
    private final String outputFileName = "aggregate_emissions_per_link_per_time.csv";

    public AggregateEmissionsDataPerLinkPerTime(Scenario scenario, double binSize) {
