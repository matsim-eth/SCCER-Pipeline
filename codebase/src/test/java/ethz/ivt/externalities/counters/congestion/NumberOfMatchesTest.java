...
public class NumberOfMatchesTest {
    ...
    public void case4() {
        ...
        eventList.add(new LinkEnterEvent(0.0, Id.createVehicleId(matsim1.getId().toString()), link01.getId()));
        // gps2 enters
        eventList.add(new PersonDepartureEvent(1.0, gps2.getId(), link01.getId(), TransportMode.car));
        eventList.add(new VehicleEntersTrafficEvent(1.0, gps2.getId(), link01.getId(), Id.createVehicleId(gps2.getId().toString()), TransportMode.car, 0.0));
        eventList.add(new LinkEnterEvent(1.0, Id.createVehicleId(gps2.getId().toString()), link01.getId()));
        ...
        // assertions
        assertTrue(congestionCounter.getGpsAgents().get(link01.getId()).get(gps1.getId()).getMatsimAgentId().isPresent());
        assertFalse(congestionCounter.getGpsAgents().get(link01.getId()).get(gps2.getId()).getMatsimAgentId().isPresent());
    }
    ...
    public void case5() {
        ...
        // assertions
        assertTrue(congestionCounter.getGpsAgents().get(link01.getId()).get(gps1.getId()).getMatsimAgentId().isPresent());
        assertTrue(congestionCounter.getGpsAgents().get(link01.getId()).get(gps2.getId()).getMatsimAgentId().isPresent());
    }
}
