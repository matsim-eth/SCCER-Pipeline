...
public class DisaggregateCongestionCounter implements CongestionEventHandler, LinkEnterEventHandler, LinkLeaveEventHandler, PersonDepartureEventHandler {
    ...
    public DisaggregateCongestionCounter(Scenario scenario, ExternalityCounter externalityCounterDelegate) {
