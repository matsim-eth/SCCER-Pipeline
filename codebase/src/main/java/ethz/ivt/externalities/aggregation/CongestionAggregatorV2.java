...
/**
 * Created by tchervec on 19.09.2019.
 */
public class CongestionAggregatorV2 implements CongestionEventHandler, LinkEnterEventHandler, PersonDepartureEventHandler, LinkLeaveEventHandler, PersonArrivalEventHandler {
    private static final Logger log = Logger.getLogger(CongestionAggregatorV2.class);
    private final Scenario scenario;
    private final Vehicle2DriverEventHandler drivers;
    private double binSize;
    private AggregateDataPerLinkPerTimeImplV2 aggregateCongestionDataPerLinkPerTime;

    private double congestionThresholdRatio = 0.65;

    public CongestionAggregatorV2(Scenario scenario, Vehicle2DriverEventHandler drivers, double binSize) {
        this.scenario = scenario;
        this.drivers = drivers;
        this.binSize = binSize;
        this.aggregateCongestionDataPerLinkPerTime = new AggregateDataPerLinkPerTimeImplV2(scenario, binSize);
    }
    ...
    public AggregateDataPerLinkPerTimeImplV2 getAggregateCongestionDataPerLinkPerTime() {
        return aggregateCongestionDataPerLinkPerTime;
    }

    @Override
    public void reset(int iteration) {
        aggregateCongestionDataPerLinkPerTime.reset();
    }
}
