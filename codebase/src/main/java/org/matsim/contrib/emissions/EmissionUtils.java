...
public final class EmissionUtils {
	...
	public static final Id<VehicleType> ELECTRIC_VEHICLE_TYPE_ID = Id.create("electric", VehicleType.class);
	...
	protected static boolean isElectricVehicle(Vehicles vehicles, Id<Vehicle> vehicleId) {
		Vehicle v = vehicles.getVehicles().get(vehicleId);
		if (v != null && v.getType().getId() == ELECTRIC_VEHICLE_TYPE_ID) {
			return true;
		}
		return false;
	}
